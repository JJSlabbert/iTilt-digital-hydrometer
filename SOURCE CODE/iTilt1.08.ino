...
#endif
#ifdef ESP32
  char i2c_sda_pin[3]="17";
  char i2c_scl_pin[3]="16";
#endif
...
void pubToCayenne(String batcap,String tempgyro,String temp,String tilt,String batvolt,String grav,String abv, float signalstrength, String mqtt_username, String mqtt_password, String mqtt_clientid)
{
  const char broker[] = "mqtt.mydevices.com";
  int        port     = 1883;
  ...
  Serial.println("Battery Capacity: "+batcap);
  Serial.println("Topic 2:"+topic2);
  Serial.println("Topic 2: "+tempgyro);
  ...
  mqttClient.print("temp,c="+tempgyro); 
  mqttClient.endMessage();
  mqttClient.beginMessage(topic3);
  mqttClient.print(1.08); 
  mqttClient.endMessage();
  mqttClient.beginMessage(topic4);
  mqttClient.print("temp,c="+temp); 
  mqttClient.endMessage();
  ...
  mqttClient.print(String(signalstrength)); 
  mqttClient.endMessage();
...
void inviniteSleep()  //This is used when battery is charged or iTilt is stored
{ 
...
//    mqttClient.setId(String(mqtt_clientid));
  ...
  pubToCayenne(String(batcap,4),String(tempgyro,2), String(temp,4),String(tilt,4),String(batvolt,4),String(grav,4), String(abv,4), signalstrength, String(mqtt_username), String(mqtt_password), String(mqtt_clientid));

  //pubToCayenne(String batcap,String tempgyro,String temp,String tilt,String batvolt,String grav,String abv, float signalstrength, String mqtt_username, String mqtt_password, String mqtt_clientid)
  startDeepSleep();      
}
