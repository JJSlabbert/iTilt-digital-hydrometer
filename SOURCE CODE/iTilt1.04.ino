...
void handlePinConfInput()
{
  ...
  htmlText+="<b>ESP32:</b><br> Power=32, One Wire(DS18B20 Data)=33,<br> GYRO MPU6050_SDA=21, GYRO MPU6050_SCL=22 <br>";
  ...
  htmlText+="<tr><td>POWER PIN 2 (ESP32 ONLY)</td><td><input type='number' name='Power Pin' size='5' min='0' max='40' step='1' value="+String(power_pin2)+" style='height:80px;font-size:30pt;'></td></tr>";  
  #endif
