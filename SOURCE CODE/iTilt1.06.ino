...
void startDeepSleep()
{
  ...
  delay(500);  //otherwise some of the cayenne channels is not publish
...
void handlePinConfInput()
{
  ...
  #ifdef ESP32
  htmlText+="<b>ESP32:</b><br> Power=2,13, Battery Voltage=39, One Wire(DS18B20 Data)=12,<br> GYRO MPU6050_SDA=4, GYRO MPU6050_SCL=0 <br>";
  htmlText+="<br>To see what pins to use for Temperature and Gyroscope sensors, <a href='https://randomnerdtutorials.com/esp32-pinout-reference-gpios/'>https://randomnerdtutorials.com/esp32-pinout-reference-gpios/</a>";
...
void handleReadings() {
  ...
  htmlText+= "<p>Tilt: " + String(tilt) + " Degrees. This value should be about 89 degrees if the iTilt is on a horizontal surface.</p>";
